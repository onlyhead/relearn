...
namespace relearn {
    namespace model_free_value_based {
         ...
         */
        template <typename StateType, typename ActionType> class DoubleDQN : public DQN<StateType, ActionType> {
          private:
         ...
         */
        template <typename StateType, typename ActionType> class DuelingDQN : public DQN<StateType, ActionType> {
          private:
